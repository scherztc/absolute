...
describe CurationConcern::VideosController do
  it_behaves_like 'is_a_curation_concern_controller', Video, actions: [:create, :update, :show]
  ...
  it "has Curate CurationConcern::Controller#edit behaviors" do
    ...
    it_behaves_like 'is_a_curation_concern_controller', Video, actions: [:edit]
  end
  ...
  describe "#new" do
    context "my work" do
      it "should show me the page" do
        ...
        expect(response.body).to have_tag('h2', :text => 'Describe Your Video')
      end
    end
  end
